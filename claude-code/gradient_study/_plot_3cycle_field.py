...
live = {}
G.train(C, N, outs, w0.copy(), T, params, rounds=800, lr=G.LR,
...
def draw(w, tag, fname):
    ...
    fig.suptitle(f"3-cycle {tag} — voltage and both field variables   "
...
draw(live["w"], f"STUCK (seed {seed}, live)", f"3cycle_field_stuck{seed}.png")
draw(list(Wl), "at the TRUE weights", "3cycle_field_true.png")

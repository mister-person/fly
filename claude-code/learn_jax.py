...
def main():
    ...
    while(True):
        ...
        # print("getting grads")
        grads = jax_model_grads_hack.synapse_weight_grads(params, jnp_con, neuron_count, jnp.array(syn_weights), jnp.array(neurons_to_activate), target_voltages)
...
def main2():
    ...
    while True:
        ...
        grad = jax_model_grads_hack.synapse_weight_grads(params, jnp_con, neuron_count, strs, jnp.array(neurons_to_activate), real_target)
